...
const AccessoiresSection = () => {
  return (
    <section id="accessoires" className="flex flex-col items-center mt-8 scroll-mt-20 md:scroll-mt-24">
      ...
      <p className="max-w-2xl text-center my-8">Description de la section accessoires, paragraphe moyennement long incluant des mots clés du type <span className="font-bold">Croquettes pour chiens heureux</span> par exemple, ou <span className="font-bold">alimentation Made in France 🇫🇷</span>, ou valeurs anti-gaspi, etc...</p>
