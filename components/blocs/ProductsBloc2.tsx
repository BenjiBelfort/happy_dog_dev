...
const ProductsBloc2 = () => {
  return (
    <article className="relative flex flex-col md:flex-row justify-center items-center text-center bg-slate-300 md:rounded-3xl p-8 shadow-lg/30 bg-[url('/pattern/pattern-dots.png')] bg-repeat max-w-4xl mx-auto my-24 gap-6">
