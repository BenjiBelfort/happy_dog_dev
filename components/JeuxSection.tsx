...
const JeuxSection = () => {
  return (
    <section id="jeux" className="flex flex-col items-center mt-12 scroll-mt-20 md:scroll-mt-24">
      ...
      <p className="md:text-xl max-w-2xl text-center my-8 mx-2">Description de la section Jeux, paragraphe moyennement long incluant des mots clés du type <span className="font-bold">Croquettes pour chiens heureux</span> par exemple, ou <span className="font-bold">alimentation Made in France 🇫🇷</span>, ou valeurs anti-gaspi, etc...</p>
